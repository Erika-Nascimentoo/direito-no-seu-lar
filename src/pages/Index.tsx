...
import { Menu, X, Phone, MapPin, Mail, Instagram, ChevronDown, Shield, Heart, Scale, Users, Clock, Star, MessageCircle, ArrowRight, CheckCircle } from "lucide-react";
...
import suporteImg from "@/assets/maria_laura_pose.jpeg";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="relative pt-24 md:pt-0 min-h-screen flex items-center bg-navy overflow-hidden">
        ...
        <div className="relative z-20 container mx-auto px-4 py-20 md:py-0">
          <div className="max-w-2xl text-center md:text-left">
            ...
            <h1 className="font-display text-3xl md:text-5xl lg:text-6xl leading-tight text-cream mb-6">
              Não deixe o plano de saúde negar o seu <span className="text-gradient-gold">direito.</span>
            </h1>
            <p className="text-cream/80 text-lg md:text-xl mb-8 font-body leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img alt="Maria Laura" className="rounded-lg shadow-elegant w-full max-w-md mx-auto" src="/lovable-uploads/38fe5917-2970-470d-bc3e-651b43862bcb.jpg" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-navy text-cream">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="font-display text-3xl md:text-4xl mb-4">Como podemos <span className="text-gradient-gold">ajudar você</span></h2>
            <p className="text-cream/70 font-body text-lg">Atuamos de forma estratégica para garantir que seu direito à saúde seja respeitado.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            map((item, i) =>
            <div key={i} className="bg-cream/5 border border-cream/10 rounded-lg p-8 hover:bg-cream/10 transition-colors">
                <item.icon size={32} className="text-accent mb-4" />
                <h3 className="font-display text-xl mb-3">{item.title}</h3>
                <p className="text-cream/70 font-body text-sm leading-relaxed">{item.desc}</p>
              </div>
            )}
          </div>
        </div>
      ...
      <section id="equipe" className="py-20 md:py-28 bg-muted">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="font-display text-3xl md:text-4xl text-foreground mb-4">Nossa <span className="text-accent">Equipe</span></h2>
      ...
      <section id="servicos" className="py-20 md:py-28 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="font-display text-3xl md:text-4xl text-foreground mb-4">Outras <span className="text-accent">Áreas de Atuação</span></h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            map((item, i) =>
            <div key={i} className="border border-border rounded-lg p-6 hover:shadow-elegant transition-shadow bg-card">
      ...
      <section className="py-20 md:py-28 bg-navy text-cream">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="font-display text-3xl md:text-4xl mb-4">Como funciona o <span className="text-gradient-gold">atendimento</span></h2>
          </div>
          <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            ...
            <div key={i} className="text-center">
                <div className="w-16 h-16 rounded-full bg-accent/20 text-accent font-display text-2xl flex items-center justify-center mx-auto mb-4">
                  {item.step}
                </div>
                <h3 className="font-display text-lg mb-2">{item.title}</h3>
                <p className="text-cream/70 text-sm font-body">{item.desc}</p>
              </div>
            )}
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="font-display text-3xl md:text-4xl text-foreground mb-4">Nossos <span className="text-accent">Diferenciais</span></h2>
          </div>
      ...
      {/* CTA */}
      <section className="py-20 md:py-28 bg-gold-accent">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="font-display text-3xl md:text-4xl text-accent-foreground mb-6">Não espere mais para garantir seu direito</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button onClick={openModal} className="px-8 py-4 rounded-md bg-foreground text-cream font-bold text-sm hover:opacity-90 transition-opacity flex items-center justify-center gap-2">
                <MessageCircle size={18} /> Fale com uma Especialista
              </button>
            </div>
          </div>
      ...
      <section id="faq" className="py-20 md:py-28 bg-background">
        <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="font-display text-3xl md:text-4xl text-foreground mb-4">Perguntas <span className="text-accent">Frequentes</span></h2>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <a href="https://instagram.com/hmadvogadas_" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-cream/70 hover:text-accent transition-colors">
                <Instagram size={14} /> @hmadvogadas_
              </a>
            </div>
          </div>
          <div className="border-t border-cream/10 pt-8 text-center text-cream/40 text-xs font-body">
